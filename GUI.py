...
program_name = Label(login_frame, text="OpenMed", fg="white", font=("Veranda", 36), pady=10, bg=background_color)
...
submit_button = Button(login_frame, text="Login", command=submitLogin)
